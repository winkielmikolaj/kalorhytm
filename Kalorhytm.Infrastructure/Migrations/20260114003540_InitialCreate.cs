        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DailyCarbohydrateGoal = table.Column<double>(type: "float", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BodyMeasurementGoals", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UsedIngredientsJson = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MissedIngredientsJson = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Amount = table.Column<double>(type: "float", nullable: false, defaultValue: 250.0),
                    UserId = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BodyMeasurementGoals_UserId_Type_EffectiveFrom",
                table: "BodyMeasurementGoals",
                columns: new[] { "UserId", "Type", "EffectiveFrom" });

            migrationBuilder.CreateIndex(
                name: "IX_BodyMeasurements_UserId_Type_MeasurementDate",
                table: "BodyMeasurements",
                columns: new[] { "UserId", "Type", "MeasurementDate" });

            migrationBuilder.CreateIndex(
                name: "IX_MealEntry_FoodId",
                table: "MealEntry",
                column: "FoodId");
        }
